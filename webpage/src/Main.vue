...
<div id="main" class="main" :class="{'main-hide-text': hideMenuText}">
  ...
  <Modal
    ...
    <h3>关于TC:</h3>
    <br>
    <p>TC 是一款基于inception的开源SQL审核平台。设计的目的便是让DBA能够从手动审核的环境中释放出来.让sql审核更加流程化,标准化,自动化。非常欢迎大家体验并使用TC!</p>
    <br>
    <H3>关于二次开发的声明:</H3>
    <br>
    <p>作为一款开源平台。TC很希望有更多的开发者一起参与到开发中。同时也鼓励各公司根据自身业务对平台进行二次开发及定制。
      TC v1.0.0 采用Apache2.0许可证,以下为许可中相关的义务与责任。</p>
